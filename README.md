...
Customize Terraform for your environment
Deploy resources via Terraform
Clone Cloud Custodian into repository into CSR
Add required inputs to jinja2 input file
(optional) Customize Cloud Custodian actions
Push update to Cloud Source Repository
(automatic) Run Cloud Build jobs
(automatic) Deploy Cloud Custodian resources
